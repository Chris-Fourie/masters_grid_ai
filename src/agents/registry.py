...
from src.agents.discrete.coagent_ac_coma import CoagentACCOMA as DisCoagentACCOMA 
from src.agents.discrete.coagent_a2c import CoagentA2C as DisCoagentA2C
from src.agents.discrete.coagent_ac_central import CoagentACCentral as DisCoagentACCentral
...
def get_agent(node_type, agent_name):
    ...
    if node_type == 'discrete':
        ...
        if agent_name == 'coagent_ac':
            return DisCoagentAC
        if agent_name == 'coagent_ac_coma':
            return DisCoagentACCOMA
        if agent_name == 'coagent_a2c':
            return DisCoagentA2C
        if agent_name == 'coagent_ac_central':
            return DisCoagentACCentral
